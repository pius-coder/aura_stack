    ...
    <VibeLayout hideNav>
      <section className="relative mx-auto flex w-full max-w-md flex-col items-center px-5 pb-16 pt-16 sm:pt-24">
        <div className="vibe-card w-full p-8 sm:p-10">
          <span className="vibe-eyebrow">Inscription</span>
          <h1 className="vibe-display mt-3 text-3xl">Bienvenue sur Vibe</h1>
          <p className="mt-3 text-sm leading-relaxed text-[var(--vibe-fg-muted)]">
            L'inscription par numéro WhatsApp arrive avec la vague
            d'authentification. Restez à l'écoute.
          </p>
